...
namespace BusinessLogicLayer {
	...
	public class BankController {
		...
		public void UpdateScreen(int screenId, TicketingScreen newScreen) {
			ScreenOperations.UpdateScreen(BankName, screenId, newScreen);
		}
		...
		public void DeleteScreen(int screenId) {
			ScreenOperations.DeleteScreen(BankName, screenId);
		}
		...
		public void DeleteScreens(List<int> screenIds) {
			ScreenOperations.DeleteScreens(BankName, screenIds);
		}

		/// <summary>
		/// Gets the ID of the active screen.
		/// </summary>
		/// <returns>The ID of the active screen. If no screens are active, it returns <c>null</c>.</returns>
		...
		public void ActivateScreen(int screenId) {
			ScreenOperations.ActivateScreen(BankName, screenId);
		}
		...
		public void DeactivateScreen(int screenId) {
			ScreenOperations.DeactivateScreen(BankName, screenId);
		}
		...
		/// </summary>
		/// <param name="screenId">The ID of the screen</param>
		/// <returns>A list of <c>TicketingButton</c> items representing the buttons of the screen.</returns>
